...
from core.views_auth import BluewhaleLoginView, get_user_info, \
    delete_user_info, update_user_info, \
...
urlpatterns = [
    ...
    path(f'{api_prefix}/delete', delete_user_info, name='delet an user'),
    path(f'{api_prefix}/update', update_user_info, name='update an user'),
